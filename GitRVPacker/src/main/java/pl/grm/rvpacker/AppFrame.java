...
public class AppFrame extends JFrame {
	...
	public AppFrame(MainPacker mpacker) {
		...
		chooser.addChoosableFileFilter(new FileNameExtensionFilter("RPG Maker Project file", "rvproj2"));
		...
		mntmAbout.addActionListener(e -> JOptionPane.showMessageDialog(AppFrame.this,
		...
		btnChooseProject.addActionListener(e -> {
			if (chooser.showOpenDialog(AppFrame.this) == JFileChooser.APPROVE_OPTION) {
		...
		tF_SelectedProject.getDocument().addDocumentListener(new DocumentListener() {
	...
	public void updateLayout() {
		String filePath;
		if ((filePath = tF_SelectedProject.getText()) != null && filePath.contains(".rvproj2")
