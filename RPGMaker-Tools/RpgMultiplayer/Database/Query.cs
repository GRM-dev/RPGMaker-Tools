namespace RpgMulti.Database
{
    public class Query
    {
        ...
        public static readonly Query PlayerUpdatePassword = new Query("UPDATE players SET `f_pswd` = @pswd WHERE `f_name`= @name");
        ...
        public static readonly Query SaveCreate = new Query("INSERT INTO saves (`player_id`, `f_pos_map_id`, `f_pos_x`, `f_pos_y`, `f_direction`) VALUES (@playerId, @mapId, @posX, @posY, @dir)");
